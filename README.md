...
130 项为 L2、35 项为 L1、32 项为 L0。S13 只确认 Linux A、Container B、native Windows
process/env B（file/network U）及其对应 L2/L1 能力；这不表示已有 Managed Policy、Auto Mode、
全平台同等级 OS Sandbox 或 S14 稳定持久化能力。S14 为 NOT_STARTED。
