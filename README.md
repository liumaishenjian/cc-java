...
41. [ADR-063](./docs/adr/ADR-063-s13-dual-source-sandbox-security-study.md)、[ADR-064](./docs/adr/ADR-064-s13-execution-backend-security-contract.md)、[S13 Gate Evidence](./docs/evidence/S13-sandbox-security-gate-2026-08-10.md)、[Demo Skeleton](./docs/demos/S13-sandbox-security.md)与[Gap Skeleton](./docs/gap-reports/S13.md)：S13 双源固定版本、ExecutionBackend/五类 policy/fallback、WSL2+bwrap Linux A、Docker B、native Windows B/macOS C-U 的三 Batch门槛；JVM 内 HTTP 不受进程 backend 强制，HOOK-10 保持 L1；当前仅 G0-G2，未实现；
