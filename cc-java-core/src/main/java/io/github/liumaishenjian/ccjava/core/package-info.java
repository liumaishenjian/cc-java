 ...
 *
 * <p>该包承载显式 Agent Loop、模型端口、工具注册与执行管线、Context Projection、
 * Memory Catalog/Repository/Recall/Projection Port 与 ready-only Prefetch、内存 Session、运行限制、停止原因和生命周期事件。核心层负责确定性的
